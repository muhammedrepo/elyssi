      ...
      <div className="grid md:grid-cols-4 md:gap-5 px-4">
        ...
        <div className="md:col-span-3">
          ...
          <div>
            ...
            <ul className="mx-auto flex justify-center py-16">
              {products.length > 0 &&
                [...Array(pages).keys()].map((pageNumber) => (
                  <li key={pageNumber}>
                    <button
                      className={`mr-3 flex h-6 w-6 cursor-pointer items-center justify-center rounded-full font-hk text-sm font-semibold text-black transition-colors hover:bg-primary hover:text-white ${
